        ...
        {productRows.map((product) => {
          ...
          return (
            <article key={product.id} className="nexa-card group relative flex min-h-full flex-col overflow-hidden bg-surface">
              ...
              <div className="pointer-events-none relative z-10 flex min-h-full flex-col">
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <div className="pointer-events-auto mt-5 grid gap-2 sm:grid-cols-2">
                    <Link
                      href={detailsHref}
        ...
        {selected ? (
          <div className="space-y-5">
            <div className="relative aspect-[16/9] overflow-hidden rounded-[18px] border border-line bg-elevated">
              ...
              <div className="absolute left-3 top-3 rounded-full bg-foreground px-3 py-1 text-xs font-bold text-white">{selected.offer}</div>
            </div>
            <div className="rounded-[18px] border border-line bg-elevated p-4">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-3">
                ...
                <Badge tone="gold">কমিশন {taka(selected.commission)}</Badge>
              </div>
            </div>
            <div>
