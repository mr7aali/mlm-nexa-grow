...
const testimonials = [
  {
    name: "তানিয়া",
    text: "প্রথম মাসেই নিজের পরিচিত নেটওয়ার্ক সাজিয়ে নিয়মিত আয়ের পথ দেখেছি।",
    earning: 12000,
  },
  {
    name: "মাহিন",
    text: "ড্যাশবোর্ডে লেভেল ট্র্যাকিং থাকায় কে কোথায় আছে পরিষ্কার বোঝা যায়।",
    earning: 28500,
  },
  {
    name: "সাবিহা",
    text: "পণ্য রেফার করা, লিংক কপি করা আর কমিশন দেখা খুব সহজ।",
    earning: 8200,
  },
];
...
export default function Home() {
  ...
  function showPreviousSlide() {
    setActiveSlide(
      (current) => (current - 1 + slideImages.length) % slideImages.length,
    );
  }
    ...
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-2 px-3 sm:h-20 sm:gap-3 sm:px-4">
          ...
          <div className="flex min-w-0 shrink-0 items-center gap-1.5 sm:gap-2">
            ...
            <details className="group relative md:hidden">
              <summary className="grid h-9 w-9 cursor-pointer list-none place-items-center rounded-full border border-white/25 text-white transition hover:bg-white/10 sm:h-10 sm:w-10 [&::-webkit-details-marker]:hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-14 md:py-16 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/90">
              GIOTO Bangladesh পণ্য বিক্রয়, রেফারেল নেটওয়ার্ক, কমিশন ট্র্যাকিং
              এবং সদস্য ব্যবস্থাপনাকে এক জায়গায় সহজ করে।
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/products"
                className="gold-button inline-flex items-center justify-center gap-2 px-7 py-3 font-bold"
              >
                পণ্য কিনে সদস্য হন <ArrowRight size={18} />
              </Link>
              <Link
                href="/dashboard"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-elevated bg-transparent px-7 py-3 font-bold text-white transition hover:bg-gold-light/20"
              >
                সদস্য ড্যাশবোর্ড
              </Link>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[32px] border border-white/25 bg-white/10 p-6 shadow-2xl backdrop-blur md:p-8">
              <div className="flex items-center justify-between gap-4">
                <BrandLogo
                  className="h-20 w-52 sm:h-24 sm:w-72"
                  framed={false}
                  variant="wide"
                />
              ...
              <div className="mt-8 grid gap-3">
                {[
                  [
                    ShoppingBag,
                    "পণ্য নির্বাচন",
                    "পছন্দের পণ্য দেখে দ্রুত অর্ডার করুন",
                  ],
                  [
                    Network,
                    "নেটওয়ার্ক বৃদ্ধি",
                    "রেফারেল শেয়ার করে সদস্য যুক্ত করুন",
                  ],
                  [
                    WalletCards,
                    "আয়ের হিসাব",
                  ...
                  return (
                    <div
                      key={String(title)}
                      className="flex items-center gap-4 rounded-2xl border border-white/15 bg-white/12 p-4 text-left"
                    >
        ...
        <div className="relative overflow-hidden rounded-xl border border-line bg-surface shadow-[0_18px_55px_rgba(232,82,10,0.12)]">
          ...
          >
            {slideImages.map((src, index) => (
              <div
                key={src}
                className="relative h-[190px] w-full shrink-0 overflow-hidden sm:h-[280px] lg:h-[465px]"
              >
                <Image
                  src={src}
      ...
      <section id="products" className="mx-auto max-w-7xl px-4 py-20">
        <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="mb-3 text-sm font-semibold text-gold-light">
              অনলাইন শপ
            </p>
            <h2 className="heading-gradient text-3xl font-bold leading-tight md:text-5xl">
              জনপ্রিয় পণ্য
            </h2>
            <p className="mt-4 max-w-2xl text-base leading-8 text-muted md:text-lg">
              সরাসরি পণ্য কিনতে dedicated public product page থেকে details ও
              checkout করুন।
            </p>
          </div>
          <Link
            href="/products"
            className="outline-gold inline-flex w-fit items-center justify-center gap-2 px-5 py-2.5 text-sm font-bold transition hover:bg-gold/10"
          >
            <ShoppingBag size={17} />
            সব পণ্য
          </Link>
        ...
        {isLoading ? (
          <p className="mb-4 text-sm text-muted">পণ্য লোড হচ্ছে...</p>
        ) : null}
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div>
            ...
            <h2 className="heading-gradient text-3xl font-black leading-tight md:text-5xl">
              পণ্য, রেফারেল ও আয়ের পুরো যাত্রা এক জায়গায় পরিচালনার সহজ
              প্ল্যাটফর্ম
            </h2>
            <p className="mt-5 max-w-2xl text-base leading-8 text-muted md:text-lg">
              GIOTO Bangladesh এমন একটি সদস্যভিত্তিক commerce platform, যেখানে
              product catalog, referral journey, commission progress, checkout
              এবং member dashboard একই অভিজ্ঞতায় সাজানো হয়েছে।
            </p>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {[
                [
                  ShieldCheck,
                  "স্বচ্ছ আয়ের পথ",
                  "রেফারেল, অর্ডার এবং কমিশনের অগ্রগতি পরিষ্কারভাবে দেখা যায়।",
                ],
                [
                  Layers3,
                  "একসঙ্গে সব module",
                  "Products, referrals, earnings ও profile একই platform-এ।",
                ],
              ].map(([Icon, title, text]) => {
          ...
          <Card className="overflow-hidden p-0">
            ...
            <div className="grid gap-0 sm:grid-cols-3">
              {[
                ...
                <div
                  key={label}
                  className="border-b border-line p-5 sm:border-b-0 sm:border-r last:border-r-0"
                >
            ...
            <div className="space-y-4 p-6">
              {[
                "পণ্য নির্বাচন করুন",
                "রেফারেল লিংক শেয়ার করুন",
                "আয় ও অগ্রগতি ট্র্যাক করুন",
              ].map((item, index) => (
                <div
                  key={item}
                  className="flex items-center gap-4 rounded-2xl border border-line bg-elevated p-4"
                >
      ...
      <section
        id="calculator"
        className="mx-auto grid max-w-7xl gap-6 px-4 py-20 lg:grid-cols-2"
      >
        <div>
          <SectionHeading
            ...
            {[...testimonials, ...testimonials].map((item, index) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="grid h-12 w-12 place-items-center rounded-full bg-gold-light/20 text-gold-light">
                    {item.name[0]}
                  </div>
                  <div>
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-6xl overflow-hidden rounded-[28px] border border-line bg-[radial-gradient(circle_at_50%_0%,rgba(232,82,10,0.24),rgba(26,26,26,1)_45%)] p-8 text-center md:p-14">
          ...
          <h2 className="heading-gradient mt-4 text-4xl font-black !text-white md:text-6xl">
            আজই নেটওয়ার্ক শুরু করুন
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-white/80">
            পণ্য শেয়ার করুন, নতুন সদস্য যুক্ত করুন এবং এক জায়গা থেকে আয়ের
            অগ্রগতি দেখুন।
          </p>
          <Link
            href="/products"
            className="gold-button mt-8 inline-flex items-center gap-2 px-8 py-3 font-bold"
          >
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-x-8 gap-y-9 px-4 py-10 lg:grid-cols-[1.2fr_0.75fr_0.75fr_1fr] lg:gap-10 lg:py-12">
          <div className="col-span-2 flex flex-col items-center text-center lg:col-span-1">
            <Link href="/" className="inline-flex w-fit items-center">
              <BrandLogo
                className="h-28 w-72 max-w-full sm:w-[26rem] lg:h-32 lg:w-[32rem]"
                framed={false}
                variant="wide"
              />
            </Link>
            <div className="mt-5 grid grid-cols-5 place-items-center gap-3">
              {[
                {
                  label: "Facebook",
                  href: "https://www.facebook.com/profile.php?id=61582547472235",
                  icon: FacebookIcon,
                },
                {
                  label: "YouTube",
                  href: "https://youtube.com/@gioto_bangladesh?si=Pfbkqjy72UQU5dQn",
                  icon: YouTubeIcon,
                },
                {
                  label: "X",
                  href: "https://x.com/GiotoBangladesh",
                  icon: XSocialIcon,
                },
                {
                  label: "TikTok",
                  href: "https://www.tiktok.com/@urbanbro_bd?_r=1&_t=ZS-96fHDwNlUo8",
                  icon: TikTokIcon,
                },
                {
                  label: "Pinterest",
                  href: "https://pin.it/5pev5NgTM",
                  icon: PinterestIcon,
                },
                {
                  label: "Threads",
                  href: "https://www.threads.com/@gioto_bd",
                  icon: ThreadsIcon,
                },
                {
                  label: "Telegram",
                  href: "https://t.me/gioto_bangladesh",
                  icon: TelegramIcon,
                },
                {
                  label: "Instagram",
                  href: "https://www.instagram.com/gioto_bd?igsh=MWZ3NjV6NHZ0bGY2eA==",
                  icon: InstagramIcon,
                },
                {
                  label: "LinkedIn",
                  href: "https://www.linkedin.com/groups/19487010",
                  icon: LinkedInIcon,
                },
                {
                  label: "WhatsApp",
                  href: "https://wa.me/8801312684708",
                  icon: WhatsAppIcon,
                },
              ].map((item) => {
          ...
          <div>
            ...
            <div className="mt-4 grid gap-3 text-sm">
              <Link
                href="/products"
                className="text-white/75 transition hover:text-gold-light"
              >
                পণ্য
              </Link>
              <a
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="mt-4 grid gap-3 text-sm text-white/75 sm:grid-cols-2 lg:block lg:space-y-3">
              <p className="flex items-center gap-3">
                <Phone size={16} className="text-gold-light" /> +8809658979698
              </p>
              <p className="flex min-w-0 items-center gap-3">
                <Mail size={16} className="shrink-0 text-gold-light" />{" "}
                <span className="break-all">contact@giotobangladesh.com</span>
              </p>
            ...
            <Link
              href="/products"
              className="mt-6 inline-flex min-h-11 items-center justify-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-bold text-foreground transition hover:bg-gold-light hover:text-white"
            >
